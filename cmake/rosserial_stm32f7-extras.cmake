...
#
# Generate a rosserial_stm32f7 ros_lib folder using the make_libraries
# script supplied by a particular package. The default is to fall back
# on the generic script in rosserial_stm32f7 itself.
#
...
function(rosserial_generate_ros_lib)
  ...
  if(NOT make_libraries_PACKAGE)
    set(make_libraries_PACKAGE rosserial_stm32f7)
  endif()
...
function(rosserial_configure_client)
  ...
  if(NOT client_DIRECTORY)
    message(SEND_ERROR "rosserial_stm32f7_add_client called without DIRECTORY argument.")
  endif()
